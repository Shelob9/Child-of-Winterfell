		...
		<div class="row">
			<div class="four columns">
				...
				<h4>Theme Development</h4>
					<p>I recently released <a href="http://complexwaveform.com/jp/winterfell" title="Winterfell WordPress Theme">Winterfell</a>, a complete theme with pintrest-style post previews and sepia color scheme. It is free to download, and I offer great rates on custom child themes to customize its look and features. This site is actually running Winterfell with a <a href="https://github.com/Shelob9/Child-of-Winterfell/tree/cwf13.1">child theme</a> that alters its appearance to suit the requirements of this site. I am also working on a starter theme <a href="http://complexwaveform.com/jp/SF/" title="_Second Foundation: WordPress Starter Theme">_Second Foundation</a>, a starter theme based on <a href="http://underscores.me">Underscores</a> and <a href="http://foundation.zurbb.com">Foundation 4</a>based on <a href="underscores.me/" title="_S WordPress Starter Theme">_S</a> and <a href="http://foundation.zurb.com" title="Foundation Framework">ZURB Foundation 4 Framework</a>. Both themes feature responsive layouts that automatically adapt to the screen size, making them equally suited for mobiel and desktop use. </p>
