	...
	<header>
		<div class="row" >
			<div class="eight columns mobile-four">
				...
				<p>Working to develop tools for environmental education and advocacy using open source software that leverages the power of online social media and promotes a re-engagement with the natural world.</p>
			</div>
